...
def main():
    ...
    group.add_argument('--start-server', action='store_true', help='Start the MCP Server')
    group.add_argument('--stop-server', action='store_true', help='Shut down the MCP Server')
    group.add_argument('--start-proxy', action='store_true', help='Start the SuperAssistant Proxy')
    group.add_argument('--stop-proxy', action='store_true', help='Shut down the SuperAssistant Proxy')
    group.add_argument('--show-mcp-logs', action='store_true', help='Show MCP Server logs (tail)')
    group.add_argument('--clear-mcp-logs', action='store_true', help='Clear the MCP Server log')
    group.add_argument('--show-proxy-logs', action='store_true', help='Show SuperAssistant Proxy logs (tail)')
    group.add_argument('--clear-proxy-logs', action='store_true', help='Clear the SuperAssistant Proxy log')
    group.add_argument('--vscode', action='store_true', help='Launch VSCode in the current directory')
